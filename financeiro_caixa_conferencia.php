...
$sqldes = "SELECT ifnull(sum(c.valor),0) as total FROM tbpedido_pagamento c where c.status='F' and c.tipo = 'DES' and DATE(c.data_pagamento) ='$data'; ";
$rstotdes = mysqli_query($conexao, $sqldes);
$row_totaldes = mysqli_fetch_array($rstotdes);

$sqldep = "SELECT ifnull(sum(c.valor),0) as total FROM tbpedido_pagamento c where c.status='F' and c.tipo = 'DEP' and DATE(c.data_pagamento) ='$data'; ";
$rstotdep = mysqli_query($conexao, $sqldep);
$row_totaldep = mysqli_fetch_array($rstotdep);
                    ...
                    <section class="card">
                        <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="bill-to text-right">
                                                    <p class="mb-0">
                                                        <p class="h4 mb-12 text-dark font-weight-semibold"><b>Saldo Atual: <?php echo number_format($row_caixa['saldo_inicial'],2,",", ".") ?><b></p>
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-6">
                                                <table class="table h6 text-dark">
                                                    <tbody>
                                                        ...
                                                        <tr class="b-top-0">
                                                            <td colspan="2"><b>Lançamentos<b></td>
                                                            <td class="text-right h5 text-dark font-weight-semibold"><?php echo number_format($row_totaldep['total'], 2, ",", ".");  ?> </td>
                                                        </tr>                                                        
                                                        <tr class="b-top-0">
                                                            <td colspan="2"><b>Despesas<b></td>
                                                            <td class="text-right h5 text-dark font-weight-semibold"><?php echo number_format($row_totaldes['total'], 2, ",", "."); ?> </td>
                                                        </tr>
                                                        <tr class="b-top-0">
                                                        ...
                                                        <tr class="h4">
                                                            ...
                                                            <?php } else { ?>
                                                                <td class="text-right"><b class="h2 text-dark font-weight-semibold"></b>0.00</td>
                                                            <?php }  ?>
                                                        </tr>
                                                    </tbody>
                                                </table>
                            ...
                            <div class="text-right mr-4">
                                <a href="caixa_conferencia_data.php?banco=<?php echo $banco ?>" class="btn btn-dark ml-3"><i class="fas fa-arrow-circle-left"></i> Voltar</a>
                                <a href="financeiro_caixa_conferencia_print.php?banco=<?php echo $banco ?>&descricao=<?php echo $descricao ?>&data=<?php echo $dataescolhi ?>&dataescolhi=<?php echo $data ?>" id="id_imprimir" target="_blank" class="btn btn-danger ml-3"><i class="fas fa-print"></i> Imprimir</a>
                            </div>
                        </div>
                    </section>
                <?php } ?>
