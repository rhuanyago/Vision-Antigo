                ...
                <div class="row">
                    <div class="col-xl-12">
                        <section class="card card-danger">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-bordered" method="POST" action="cad_categoria_insert.php" id="Cadastro" name="Cadastro">
                        ...
                        <section class="card card-default">
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-lg-12">
                                    <div class="center">
                                        <?php
                                        if (isset($_SESSION['erro_cad_categoria_excluir'])) :
                                            ?>
                                            <div class="alert alert-danger">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                <strong>Atenção! <?php echo $_SESSION['erro_cad_categoria_excluir'] ?></strong>
                                            </div>
                                        <?php
                                        endif;
                                        unset($_SESSION['erro_cad_categoria_excluir']);
                                        ?>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="center">
                                        <?php
                                        if (isset($_SESSION['cad_categoria_excluir'])) :
                                            ?>
                                            <div class="alert alert-success">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                <strong>Sucesso! <?php echo $_SESSION['cad_categoria_excluir'] ?></strong>
                                            </div>
                                        <?php
                                        endif;
                                        unset($_SESSION['cad_categoria_excluir']);
                                        ?>
                                    </div>
                                </div>
                                <table class="table table-responsive-md table-hover mb-0">
                                    ...
                                    <tbody>
                                        <?php while ($rows_rscategoria = mysqli_fetch_array($result)) { ?>
                                            <tr style="font-size:14px;">
                                                <td><?php echo $rows_rscategoria['idcategoria']; ?></td>
                                                <td class="text-left"><?php echo $rows_rscategoria['nome'] ?></td>
                                                <td class="text-center">
                                                    <?php if ($rows_rscategoria['habilitado'] == 'S') { ?>
                                                        <span class="badge badge-success">Sim</span>
                                                    <?php } ?>
                                                    <?php if ($rows_rscategoria['habilitado'] == 'N') { ?>
                                                        <span class="badge badge-danger">Não</span>
                                                    <?php } ?>
                                                </td>
                                                <td class="actions-hover actions-fade text-center">
                                                    <a class="btn btn-dark text-white" href="cad_categoria_alterar.php?idcategoria=<?php echo $rows_rscategoria['idcategoria']; ?>"><i class="fas fa-pencil-alt"></i></a>
                                                    <a href="cad_categoria_excluir.php?idcategoria=<?php echo $rows_rscategoria['idcategoria']; ?>" class="btn btn-danger text-white"><i class="far fa-trash-alt"></i></a>
                                                </td>
                                            </tr>
                                        <?php  } ?>
                                    </tbody>
