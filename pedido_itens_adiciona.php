...
$row_ped = mysqli_fetch_array($result2);
                    ...
                    <div class="col-md-12 order-1 mb-4">
                        <section class="card card-danger">
                            <header class="card-header">
                                <h2 class="card-title">Incluir Produtos / Pedido - <?php echo $idpedido ?></h2>
                            </header>
                            <div class="card-body">
                                <div class="col-lg-12">
                                    <div class="center">
                                        <?php
                                        if (isset($_SESSION['msg_erro_prod_add'])) :
                                        ?>
                                            <div class="alert alert-danger">
                                                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                                <strong>Atenção! <?php echo $_SESSION['msg_erro_prod_add'] ?></strong>
                                            </div>
                                        <?php
                                        endif;
                                        unset($_SESSION['msg_erro_prod_add']);
                                        ?>
                                    </div>
                                </div>
                                <form method="POST" action="comanda_item_insert.php">
                                    <div class="row">
                                        <div class="col-sm-1">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="referencia" id="referencia" onblur="myFunction()" class="form-control text-weight-bold" maxlength="8" upper readonly>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                                ...
                                                                ?>
                                                                    <tr style="font-size:14px;">
                                                                        ...
                                                                        <td class="actions-hover actions-fade text-center">
                                                                            <a href="comanda_itens_excluir.php?idpedido=<?php echo $rows_rsitens['idpedido'] ?>&iditem=<?php echo $rows_rsitens['iditem'] ?>" class="btn btn-danger text-white"><i class="far fa-trash-alt"></i></a>
                                                                        </td>
                                                                    </tr>
