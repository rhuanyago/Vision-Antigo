				...
				<div class="row">
					<div class="col-xl-12 order-1 mb-4">
						<section class="card card-danger">
							...
							<div class="card-body">
								<form class="form-horizontal form-bordered" method="POST" action="cad_usuario_insert.php" id="Cadastro" name="Cadastro">

									<div class="col-lg-12">
										<div class="center">
											<?php
											if (isset($_SESSION['status_cad_usuario'])) :
											?>
												<div class="alert alert-success">
													<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
													<strong>Sucesso! <?php echo $_SESSION['status_cad_usuario'] ?> </strong><br>
												</div>
											<?php
											endif;
											unset($_SESSION['status_cad_usuario']);
											?>
										</div>
									</div>
									<div class="col-lg-12">
										<div class="center">
											<?php
											if (isset($_SESSION['erro_cad_usuario'])) :
											?>
												<div class="alert alert-danger">
													<button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
													<strong>Atenção! <?php echo $_SESSION['erro_cad_usuario'] ?></strong>
												</div>
											<?php
											endif;
											unset($_SESSION['erro_cad_usuario']);
											?>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<div class="input-group">
												...
												<input type="text" name="nome" autocomplete="off" class="form-control" required maxlength="100">
											</div>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<div class="input-group">
												...
												<input type="password" autocomplete="off" name="senha" class="form-control" required maxlength="10">
											</div>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<div class="input-group">
												...
												<input type="password" autocomplete="off" name="senha_confirma" class="form-control" required maxlength="10">
											</div>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<div class="input-group mb-3">
												...
												<input type="text" autocomplete="off" name="email" class="form-control" id="email" required>
											</div>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<input type="text" autocomplete="off" name="rg" inputmode="numeric" class="form-control" required maxlength="20">
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<div class="input-group">
												...
												<input id="date" autocomplete="off" inputmode="numeric" name="dtnascimento" id="dtnascimento" data-plugin-masked-input data-input-mask="99/99/9999" placeholder="__/__/____" class="form-control" required>
											</div>
										</div>
									</div>
									...
									<div class="form-group row">
										...
										<div class="col-lg-6">
											<div class="input-group">
												...
												<input id="telefone" autocomplete="off" inputmode="numeric" name="telefone" id="telefone" placeholder="(DD) 99699-1234" class="form-control" required>
											</div>
										</div>
									</div>
